 ...
 *   => 딱히 선언하지 않아도 속성은 public static final로 선언이 되고 		// static: 객체 생성없이 클래스명으로 접근 가능, final: 수정할 수 없음
...
interface Flyer extends Cloneable{		// interface 간의  상속은 extends
	int Type = 1;						// public static final
...
public class InterfaceTest {
	public static void main(String[] args) {
		System.out.println(Flyer.Type);		// Type이 static 이므로 객체 생성 없이 접근 가능
//		Flyer.Type = 3;						// Type이 final 이므로 값을 변경할 수 없다.
