...
/**
 * Two-Point Algorithm(투 포인터 알고리즘) : // sliding window와 차이점 비교하기 (면접질문)
...
//		   	2.3 현재 부분의 합이 target 보다 크다면 start 를 1 증가
//				==> for 문이 start 를 증가시킴
			sum -= data[start];		// start 가 증가하기 전에 sum 에서 start 부분을 제거해야 한다.
